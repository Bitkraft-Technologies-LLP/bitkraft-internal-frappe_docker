...
variable "FRAPPE_REPO" {
    default = "https://github.com/Bitkraft-Technologies-LLP/bitkraft-internal-frappe"
}

variable "ERPNEXT_REPO" {
    default = "https://github.com/Bitkraft-Technologies-LLP/bitkraft-internal-erpnext"
}
